...
<section class="pageHead">
  <div class="container">
    <h1 class="page-title">Teszt blog poszt</h1>
  </div>
</section>
...
<section class="content">
  <div class="container container--narrow">
    ...
    <article class="infoCard infoCard--post">
      ...
      <div class="post-meta">
        <span class="date">2026-02-09T21:44:01</span>
        <span class="author">admin</span>
      </div>

      
      <figure class="post-image">
        <img src="https://admin.3doptika.hu/wp-content/uploads/2026/02/IMG_59361.jpg" alt="Teszt blog poszt">
      </figure>
      

      <div class="post-content">
        
<p class="has-medium-font-size"><strong>L</strong>orem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
